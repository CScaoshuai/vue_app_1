...
server.get("/box",(req,res)=>{
  var rows=[
    {id:1,title:"精品推荐：春季2019中长款V",no_pice:299,pice:259,img_url:"http://127.0.0.1:3000/img/box/banner1.jpg"},
    {id:2,title:"精品推荐：时尚修身韩版精品",no_pice:149,pice:139,img_url:"http://127.0.0.1:3000/img/box/banner2.jpg"},
	{id:3,title:"精品推荐：MII女装新款夏季潮流",no_pice:149,pice:139,img_url:"http://127.0.0.1:3000/img/box/banner3.jpg"},
  ];
  res.send(rows)
})
...
server.get("/pages",(req,res)=>{
  var rows=[{
    id:1,img1:"http://127.0.0.1:3000/img/mp4/m1.jpg",
    id:2,img2:"http://127.0.0.1:3000/img/mp4/m2.jpg",
    id:3,img3:"http://127.0.0.1:3000/img/mp4/m3.jpg",
    id:4,img4:"http://127.0.0.1:3000/img/mp4/mm.mp4" ,
    id:5,img5:"http://127.0.0.1:3000/img/mp4/ee.jpg"
  }]
  res.send(rows)
})
...
server.post("/addcomment",(req,res)=>{
  ...
  //2:sql
  var sql = "INSERT INTO mq_conmment VALUES(null,?,?,now())";
...
server.get("/getShopCart",(req,res)=>{
  ...
  if(!req.session.uid){
   ...
   var sql="SELECT id,pid,price,uid,pname FROM mq_cart WHERE uid=?";
...
server.get("/addcart",(req,res)=>{
  //0:向数据表 mq_cart 添加一列count INT
  //ALTER TABLE mq_cart ADD count INT;
  //UPDATE mq_cart SET count = 1;
  ...
  var sql = "SELECT id FROM mq_cart WHERE uid = ? AND pid = ?";
...
server.get("/findProduct",(req,res)=>{
 ...
 //2:sql  select
 var sql = "SELECT Iid, price,pic,title FROM products_img WHERE Iid = ?"; 
 //3:json {code:1,data:[]}
